import { CharacterTypeEnum, ICharacter, ICharacterConfig, CharacterCreator, ICharacterFactoryRegistry } from './defintion';
...
export class CharacterFactoryRegistry implements ICharacterFactoryRegistry {
  ...
  private readonly defaultIdGenerator = () => Bun.randomUUIDv7();
