...
export class ReportContainer {
  private strategies: Map<string, ReportStrategy<any>> = reportContextMap;
  ...
  getStrategy(fileType: keyof typeof FileType): ReportStrategy<any> {
  ...
  getAllStrategies(): Map<string, ReportStrategy<any>> {
