...
export class User implements IUser {
	...
	async listNotifications(id: TUserId): Promise<INotificationDTO[]> {
		// Implementation to list notifications for a user
		return this.notificationService.queryNotifications({ userId: id });
	}
